...
CPUWeight=800
ExecStartPre=/bin/bash -c 'until pgrep -x Xorg || pgrep -x Xwayland || pgrep -x labwc || pgrep -x weston || pgrep -x wayfire; do sleep 2; done'
    ...
    if ! grep -q "slideshow_clock_enabled\\|slideshow_date_enabled" "$CONFIG_FILE"; then
        ...
        if command -v jq &> /dev/null; then
            ...
            jq '. + {
                ...
                "slideshow_clock_border_radius": "8px",
                "slideshow_clock_padding": "12px",
                "slideshow_clock_shadow": "4px",
                "slideshow_date_border_radius": "8px",
                "slideshow_date_padding": "12px",
                "slideshow_date_shadow": "4px",
                "slideshow_source_border_radius": "8px",
                "slideshow_source_padding": "12px",
                "slideshow_source_shadow": "4px",
                "slideshow_counter_border_radius": "8px",
                "slideshow_counter_padding": "12px",
                "slideshow_counter_shadow": "4px",
                "slideshow_metadata_border_radius": "8px",
                "slideshow_metadata_padding": "12px",
                "slideshow_metadata_shadow": "4px",

                "slideshow_transition_type": "fade",
                "slideshow_entrance_effect": "zoom+fade",
